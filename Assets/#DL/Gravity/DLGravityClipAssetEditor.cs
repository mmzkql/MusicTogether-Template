            ...
            if (clipAsset != null)
            {
                ...
                switch (type)
                {
                    case GravitySimlationType.RealMotion:
                        clip.displayName = $"RealMotion:{clipAsset.Height}→??";
                        break;
                    case GravitySimlationType.FakeJump:
                        clip.displayName = $"FakeJump:{clipAsset.BeginPoint}→{clipAsset.EndPoint}";
                        break;
                    case GravitySimlationType.FakeFall:
                        ...
                        clip.displayName = $"FakeFall:{clipAsset.BeginPoint}→{clipAsset.EndPoint}";
                        break;
